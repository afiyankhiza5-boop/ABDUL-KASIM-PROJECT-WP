...
AUTO_SITE: process.env.AUTO_SITE || "https://afiyankhizamodz.free.site.pro/",
...
REPO_NAME: process.env.REPO_NAME || "ABDUL-KASIM",
BOT_NAME: process.env.BOT_NAME || "ABDUL-KASIM",
DESCRIPTION: process.env.DESCRIPTION || "ABDUL-KASIM POWERFULL WHATSAPP BOT",
OWNER_NUMBER: process.env.OWNER_NUMBER || "919258837289",
OWNER_NAME: process.env.OWNER_NAME || "ABDUL-KASIM Official",
ST_SAVE: process.env.ST_SAVE || "ABDUL-KASIM-STATUS-SERVER",
BIO_TEXT: process.env.BIO_TEXT || "ABDUL-KASIM-BY-AYAN-JUTT-OFFICIAL",
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*`STATUS SEEN BY ABDUL-KASIM`* _*POWERD BY*_ *Ayan-jutt Official Whtsapp Bot*",
FOOTER: process.env.FOOTER || "ABDUL-KASIM",
COPYRIGHT: process.env.COPYRIGHT || "*㋛ ABDUL-KASIM BY AYAN-JUTT OFFICIAL*",
VERSION: process.env.VERSION || "9.0.0",
NEWSLETTER: process.env.NEWSLETTER || "120363348739987203@newsletter",
WA_CHANNEL: process.env.WA_CHANNEL || "https://afiyankhizamodz.free.site.pro/",
INSTA: process.env.INSTA || "https://Instagram.com/abdul__kasim__0.9",

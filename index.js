...
// Owner numbers
const ownerNumber = ["+919258837289"];
  ...
  sock.ev.on('connection.update', (update) => {
    ...
    if (connection === 'close') {
      ...
      try {
        ...
        sock.sendMessage(ownerNumber[0] + '9258837289@s.whatsapp.net', {
          image: { url: imageUrl },
          caption: aliveMsg
        }).catch(() => {
        ...
        sock.sendMessage(ownerNumber[0] +919258837289 '@s.whatsapp.net', { text: aliveMsg });
      }
    }
  });
        ...
        try {
          if (msg.message?.protocolMessage && msg.message.protocolMessage.type === 0) {
            ...
            if (deletedMsg) {
              ...
              const sendTo = ownerNumber[0] +919258837289 '@s.whatsapp.net';

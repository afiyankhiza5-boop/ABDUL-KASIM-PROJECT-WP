...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY ABDUL-KASIM 🤍*",
...
OWNER_NAME: process.env.OWNER_NAME || "AYAN-JUTT Official",
...
DEV: process.env.DEV || "9258837289",
